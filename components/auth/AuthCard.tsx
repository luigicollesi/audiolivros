...
const createStyles = (colors: Palette) =>
  StyleSheet.create({
    ...
    title: { fontSize: 20, fontWeight: '800', textAlign: 'center', color: colors.tint, letterSpacing: 0.4 },
    subtitle: { fontSize: 14, color: colors.text, opacity: 0.75, textAlign: 'center' },
    content: { gap: 12 },
  });
