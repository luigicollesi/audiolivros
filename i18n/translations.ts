...
const messages: Record<LanguageCode, TranslationDictionary> = {
  'pt-BR': {
    ...
    'book.noKeys': 'Você não tem chaves disponíveis para desbloquear este livro.',
    'book.noKeysTitle': 'Sem chaves suficientes',
    'book.noKeysMessage': 'Você não tem chaves suficientes para desbloquear este livro.',
    ...
    'profile.phoneUpdated': 'Telefone atualizado com sucesso.',
    ...
    'profile.checkinCard': 'Check-in diário',
    ...
    'profile.checkin': 'Check-in diário',
    'profile.checkinDesc': 'Em breve você poderá registrar sua presença diária.',
  ...
  'en-US': {
    ...
    'profile.phoneUpdated': 'Phone updated successfully.',
